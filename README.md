...
<a href="#Schematic">Click here to skip to the schematic.</a>
...
<a id="Schematic">The connection can be followed as in this image :</a>
<br><a href="https://www.tinkercad.com/things/bhkltIIL1Fd-music-using-piezoelectric-buzzer-and-arduino/editel"><img src="https://res.cloudinary.com/ritikadas/image/upload/v1596320065/My_Images/buzzer_e8bd0b.jpg" alt="Schematic" height="420px"></a><br>If you wish to virtually simulate this project due to unavailability of components, go ahead and click on the above picture! It'll take you where you'll have the options of "Start Simulation" - if you directly want to see what it's like, and "Tinker This" - if you want to create a copy for yourself without altering the original project, tweak the code and then start simulation.<br>
Did you know that the note recognition range for the Note Recognizer App is E2 - G7? That is, no whistle notes.<br>
If you think that your final Arduino song sounds a bit low on the pitch, just change all the musical notes in <code>int melody[]</code> up one scale : change NOTE_CS4 to NOTE_CS5, NOTE_G5 to NOTE_G6 and so on, keeping the durations same. Trust me, it will automatically sound better! Or maybe close to this : <br>
